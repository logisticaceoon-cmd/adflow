    ...
    <div className="max-w-2xl">
      ...
      {toast && (
        <div className="fixed top-6 right-6 z-50 px-4 py-3 rounded-xl text-sm font-semibold shadow-xl"
          style={{
            background: toast.ok ? 'rgba(6,214,160,0.15)' : 'rgba(239,68,68,0.15)',
            border: `1px solid ${toast.ok ? 'rgba(6,214,160,0.4)' : 'rgba(239,68,68,0.4)'}`,
            color: toast.ok ? '#06d6a0' : '#ef4444',
          }}>
          {toast.msg}
        </div>
      )}
