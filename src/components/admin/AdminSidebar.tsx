        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
            ...
            return (
              <Link key={href} href={href}
                ...
                style={active ? {
                  ...
                  color: '#ffffff',
                  boxShadow: 'inset 3px 0 0 #e91e8c',
                } : {}}>
                <Icon
                  size={16}
                  style={{ color: active ? '#ffffff' : '#e91e8c', opacity: active ? 1 : 0.7 }}
          ...
          <div className="mt-auto pt-4 flex flex-col gap-0.5">
            ...
            <Link href="/dashboard"
              ...
              style={{ color: '#6b8a8a' }}>
              <Eye size={16} strokeWidth={1.75} style={{ color: '#e91e8c', opacity: 0.5 }} />
              <span className="text-[13px] whitespace-nowrap">Ver panel usuario</span>
            </Link>
            <button onClick={handleLogout}
              className="nav-item nav-item-inactive text-left"
              style={{ color: '#6b8a8a' }}>
              <LogOut size={16} strokeWidth={1.75} style={{ color: '#e91e8c', opacity: 0.5 }} />
